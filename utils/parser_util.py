...
def add_data_options(parser):
    ...
    group.add_argument("--dataset", default='humanml', choices=['humanml', 'kit', 'humanact12', 'uestc', 'h2s'], type=str,
...
def add_training_options(parser):
    ...
    group.add_argument("--lr", default=1e-2, type=float, help="Learning rate.")
    group.add_argument("--weight_decay", default=0.0, type=float, help="Optimizer weight decay.")
    group.add_argument("--lr_anneal_steps", default=10, type=int, help="Number of learning rate anneal steps.")
...
def add_generate_options(parser):
    ...
    group.add_argument("--motion_length", default=11, type=float,
...
def get_cond_mode(args):
    if args.unconstrained:
        cond_mode = 'no_cond'
    elif args.dataset in ['kit', 'humanml', 'h2s']:
        cond_mode = 'text'
    else:
        cond_mode = 'action'
    return cond_mode
